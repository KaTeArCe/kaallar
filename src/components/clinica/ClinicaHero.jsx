...
import clinicaImage from "../../assets/images/clinica.jpg";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: `url(${clinicaImage})` }}
      />
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-20">
        <div className="max-w-2xl">
          ...
          <p className="mb-8 text-lg leading-8 text-neutral-200">
            Tratamientos faciales, dermatología y medicina estética con un enfoque
            profesional, seguro y completamente personalizado.
          </p>
