      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <h2 className="mb-6 text-5xl font-bold leading-tight">
            Tu bienestar comienza con una valoración.
          </h2>

          <p className="mb-10 text-lg leading-8 text-neutral-300">
            Agenda una cita con nuestros especialistas y recibe una atención
            personalizada en un ambiente moderno, seguro y completamente privado.
          </p>
