      ...
      <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mb-10 text-lg leading-8 text-neutral-300">
            Estamos ubicados en San José, donde podrás conocer nuestras
            colecciones, probarte las prendas y recibir asesoría personalizada.
          </p>
