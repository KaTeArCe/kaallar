...
const posts = [
  { image: salon1, likes: 1248 },
  { image: salon2, likes: 986 },
  { image: salon3, likes: 1754 },
  { image: salon4, likes: 1103 },
];

function SalonInstagram() {
  const instagramUrl = "https://www.instagram.com/afroticas/";
        ...
        <div className="mb-14 flex flex-col items-center justify-between gap-6 md:flex-row">
          <div>
            ...
            <p className="text-neutral-600">
              Estilos, rizos, color y transformaciones inspiradas en @afroticas.
            </p>
          </div>
